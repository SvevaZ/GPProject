...
import rasterio
import glob, os
from ZIPRA import Band_extraction
...
class TestZipra(unittest.TestCase):
    def test_band_estraction(self):
        ...
        output_file, bands = Band_extraction(zip_path)
        ...
        output_file, bands = Band_extraction(safe_path, requested)
