""" THIS IS THE MINIMUM WORKING EXAMPLE OF THE ZIPRA LIBRARY

It can be run just with the libraries in environment_minimal.yml
...
path='EXAMPLES/DATA/S2B_MSIL2A_20250917T102019_N0511_R065_T32TNR_20250917T155807.SAFE.zip'
class_list=[0,6]
SCL_band=6
AOI="POLYGON ((9.400000 45.752193, 9.400000 46.008409, 9.684448 46.008409, 9.684448 45.752193, 9.400000 45.752193))"
