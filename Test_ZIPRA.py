...
class TestZipra(unittest.TestCase):
    ...
    def test_functions(self):
        ...
        """
        AGGIUNGI QUESTI TEST AL FILE test_zipra.py 
        ...
        ## INDICES CALCULATION TESTS (CONTINUAZIONE)
        ...
        self.assertEqual(set(calculated_indices), {"NDVI", "NBR", "NDWI"},
                         "Should calculate default indices")

        # Check that 3 indices were added to original bands
        original_bands = open_raster(tiff_file)
        ...
        tiff_single, calc_single = Indices_calculation(tiff_file, index_list=["NDVI"])
        ...
        tiff_multi, calc_multi = Indices_calculation(tiff_file, index_list=requested_indices)
        ...
        tiff_first, calc_first = Indices_calculation(tiff_file, index_list=["NDVI", "NBR"])
        ...
        tiff_evi, calc_evi = Indices_calculation(tiff_file, index_list=["EVI"])
        ...
        tiff_ndbi, calc_ndbi = Indices_calculation(tiff_file, index_list=["NDBI"])
